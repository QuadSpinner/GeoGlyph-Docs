SContrast works by adjusting the contrast based on the neighborhood of each section of the terrain as opposed to the blanket equalization done by the Equalizer.
