Blocky is a unique effect which creates long, vertical platforms on a given noise or terrain. It can be used either as is, or distorted for more prominent effects.
